...
(function(root, factory) {
  ...
  _.extend(Transition.prototype, {
    ...
    addTransitionAction : function(transitionAction) {
      ...
      if(transitionAction.func && _.isFunction(transitionAction.func) &&
        transitionAction.priority && _.isNumber(transitionAction.priority)) {
        ...
        throw new Error("Illegal format of action");
      }
    },
  ...
  var buildActions = function(actionDesc, stateMachinePrototype) {
    ...
    if(_.isFunction(actionDesc)) {
      ...
      priority = actionDesc[Keywords.PRIORITY] || Priority.NORMAL;
  ...
  var buildTransitionModel = function(transitionInfo, states, stateMachinePrototype) {
    ...
    // discover extension method if any
