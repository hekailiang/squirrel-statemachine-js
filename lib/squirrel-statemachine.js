...
(function(root, factory) {
  ...
  _.extend(State.prototype, {
    ...
    addStateAction : function(actions, isEntry) {
  ...
  var extend = function(stateMachineProps, staticProps) {
    var stateMachineClass = classExtend.call(this, stateMachineProps, staticProps),
      ...
      stateId, stateModel, stateInfo, actions, 
      fromState, toState, transition, 
      states = stateMachinePrototype._states = {}, i;

    // merge state machine definition first
