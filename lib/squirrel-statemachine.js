...
(function(root, factory) {
  ...
  function invokeActions(actions, stateContext) {
    actions.forEach(function(action) {
      action.func.call(stateContext.stateMachine,
  ...
  _.extend(StateMachine.prototype, Events, {
    ...
    fire : function(event, context) {
      var rawStates = this._states[this.currentState];
      var stateContext = {
      ...
      rawStates.internalFire(stateContext);
  ...
  var extend = function(stateMachineProps, staticProps) {
    ...
    (function() {
      // build state model
      var stateId, stateModel, stateInfo, action;
    ...
    (function() {
      // build transitions model
      var i, transitionInfo, fromState, toState, transition, action;
